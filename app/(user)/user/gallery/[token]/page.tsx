...
// A tárolt URL-ből (akármi legyen a transzformáció) kicseréljük
// a transzformációs blokkot w_2400,q_auto,f_auto-ra
      ...
      <div className="min-h-screen bg-[#FAF8F4] flex items-center justify-center px-6">
        <div className="w-full max-w-sm">
          <div className="text-center mb-8">
            ...
            <h1 className="font-['Cormorant_Garamond'] text-[2rem] font-light text-[#1A1510]">
    ...
    <>
      ...
      <div className="min-h-screen bg-[#FAF8F4]">
        ...
        {heroCoverUrl ? (
          // ── Cover photós hero ──────────────────────────────
          <div
            className="relative overflow-hidden bg-[#1A1510]"
            style={{ height: "clamp(300px, 55vh, 620px)" }}
          >
            {/* Nagy felbontású cover kép */}
            <img
              src={heroCoverUrl}
              alt=""
            ...
            <div
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(0,0,0,0.65) 0%, rgba(0,0,0,0.1) 60%, rgba(0,0,0,0.05) 100%)",
              }}
            />
            <div
              className="absolute inset-0"
            ...
            <div className="absolute bottom-0 left-0 right-0 px-6 sm:px-10 pb-10 z-10">
              <div className="max-w-4xl">
                ...
                {names && (
                  <h1
                    className="font-light text-white leading-[0.9] mb-4"
                    style={{
                  ...
                  <div className="flex items-center gap-5 ml-auto">
                    {images.length > 0 && (
                      <div className="text-right">
                        ...
                        <div className="text-[9px] tracking-[0.15em] uppercase text-white/40 mt-0.5">
                          fotó
                        </div>
                      </div>
                    )}
          ...
          <div className="bg-white border-b border-[#EDE8E0] px-5 sm:px-8 py-8">
            <div className="max-w-5xl mx-auto">
              ...
              <h1 className="font-['Cormorant_Garamond'] text-[2.2rem] font-light text-[#1A1510]">
