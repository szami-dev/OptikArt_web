...
const slides = [
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/gallery/portrait/liliMesiFranka-web -127.jpg", alt: "Férfi portré", aspect: "2/3" },
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/gallery/event/borfesztUTSO-147.JPG", alt: "Borfesztivál", aspect: "3/2" },
      { src: "/gallery/event/borfesztUTSO-106.JPG", alt: "Tömegrendezvény", aspect: "3/2" },
      { src: "/gallery/event/kurultaj-145.JPG", alt: "Kurultáj", aspect: "3/2" },
    ],
  ...
  },
  {
    ...
    accent: "#1A1510",
    images: [
      { src: "/gallery/marketing/bts-9.JPG", alt: "Termékfotó", aspect: "1/1" },
      { src: "/gallery/marketing/bts-10.JPG", alt: "TikTok forgatás", aspect: "2/3" },
      { src: "/gallery/marketing/bts-9.JPG", alt: "Brand videó", aspect: "3/2" },
      { src: "/gallery/marketing/bts-11.JPG", alt: "Influencer", aspect: "2/3" },
    ],
  ...
  },
  {
    ...
    accent: "#C8A882",
    images: [
      { src: "/gallery/drone/alfold-63 másolata.JPG", alt: "Táj légifotó", aspect: "16/9" },
      { src: "/gallery/drone/alfold-64 másolata.JPG", alt: "Város felülről", aspect: "3/2" },
      { src: "/gallery/drone/alfold-65 másolata.JPG", alt: "Absztrakt táj", aspect: "1/1" },
    ],
