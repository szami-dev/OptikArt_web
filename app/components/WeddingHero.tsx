  ...
  useEffect(() => {
    ...
    async function init() {
      ...
      ctx = gsap.context(() => {
        ...
        // CTA gombok – külön osztály, egyszerre animálódnak
        .fromTo(".wh-cta-item",
          { opacity: 0, y: 14 },
        ...
        // Alsó sor elemek (referencia + scroll) – külön, késő
    ...
    >
      ...
      >
        ...
        <div className="flex items-start gap-5 pt-8 sm:pt-10">
          <div className="wh-line-left w-px bg-[#C8A882]/40 origin-top shrink-0" style={{ height: "72px" }} />
        ...
        <div className="flex-1 flex items-center py-10">
          <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10 items-end">
            ...
            <div className="lg:col-span-8 xl:col-span-7">
              ...
              >
                <div className="wh-title-line opacity-0 overflow-hidden"><span className="block">A ti</span></div>
                <div className="wh-title-line opacity-0 overflow-hidden"><span className="block">történetetek</span></div>
                <div className="wh-title-line opacity-0 overflow-hidden">
                  <em className="block not-italic" style={{ color: "#C8A882" }}>örökre.</em>
                </div>
              </div>

              {/* CTA gombok – wh-cta-item osztály, nem wh-bottom-item */}
      ...
      <div className="absolute right-6 top-1/2 -translate-y-1/2 hidden xl:flex flex-col items-center gap-3 z-[2]">
        ...
        <span className="text-[7px] tracking-[0.3em] uppercase text-white/20" style={{ writingMode: "vertical-rl" }}>Budapest · Hungary</span>
        <div className="w-1 h-1 rounded-full bg-[#C8A882]/40" />
