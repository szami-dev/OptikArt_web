...
function getCloudinaryUrl(originalUrl: string, transformation: string) {
  ...
  // Beszúrjuk a transzformációt az /upload/ rész után
      ...
      const res = await fetch(`/api/galleries/${gallery.id}/images`, {
        ...
        body:    JSON.stringify({
          images: results.map(r => ({
            ...
            // EZT ÍRD ÁT: Generáljuk le a transzformált URL-eket
            thumbnailUrl: getCloudinaryUrl(r.secure_url, "c_fill,h_400,w_400,g_auto,q_auto,f_auto"),
            previewUrl:   getCloudinaryUrl(r.secure_url, "c_limit,w_1200,h_900,q_auto,f_auto"),
