        ...
        {tab === "overview" && (
          <div className="flex flex-col gap-5">
            ...
            {(status === "ON_HOLD" || status === "CANCELLED") && (
              <div className="bg-white border p-5 sm:p-6 flex items-center gap-4" style={{ borderColor: sm.border }}>
            ...
            {/* ── FIZETÉSI KÁRTYA (csak olvasható) ── */}
            {(project.totalPrice != null || pm) && (
              <div className="bg-white border p-5 sm:p-6" style={{ borderColor: pm ? pm.border : "#EDE8E0" }}>
                ...
                <div className="flex flex-col sm:flex-row sm:items-start gap-5">
                  ...
                  {pm && (
                    <div className="flex-1">
                      ...
                      <span className="inline-flex items-center gap-2 text-[11px] tracking-[0.08em] px-3 py-1.5 border font-medium mb-3"
                        style={{ color: pm.color, background: pm.bg, borderColor: pm.border }}>
                ...
                {/* Fizetésre ösztönző CTA ha PENDING vagy OVERDUE */}
            ...
            {project.galleries.length === 0 ? (
              ...
              <div key={gallery.id} className="bg-white border border-[#EDE8E0] overflow-hidden">
                ...
                {gallery.images.length > 0 ? (
                      ...
                      {gallery.images.slice(0, 12).map(img => (
                        <div key={img.id} className="relative bg-[#FAF8F4] overflow-hidden border border-[#EDE8E0]" style={{ aspectRatio: "1/1" }}>
                          {img.filePath
                            ...
                            : <div className="w-full h-full flex items-center justify-center"><svg viewBox="0 0 24 24" fill="none" stroke="#EDE8E0" strokeWidth="1" className="w-5 h-5"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg></div>}
                        </div>
                      ))}
                  ...
                  <div className="px-5 py-8 text-center"><p className="text-[12px] text-[#C8B8A0]">Nincs feltöltött kép ebben a galériában.</p></div>
                )}
              </div>
            ))}
          </div>
