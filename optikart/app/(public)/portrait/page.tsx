...
const categories = [
  {
    id: "paros", title: "Páros & Jegyesfotózás", subtitle: "Kettőtök világa",
    desc: "Helyszíni vagy stúdió fotózás, amely megörökíti a köztetek lévő kémia minden apró jelét.",
    images: ["https://images.unsplash.com/photo-1519741497674-611481863552?w=700&q=75", "https://images.unsplash.com/photo-1511285560929-80b456fea0bc?w=700&q=75", "https://images.unsplash.com/photo-1465495976277-4387d4b0b4c6?w=700&q=75"],
    price: "35 000 Ft-tól", duration: "1–2 óra",
  },
  {
    id: "csaladi", title: "Családi fotózás", subtitle: "Együtt az egész csapat",
    desc: "Természetes, életteli képek a családról — gyerekekkel, nagyszülőkkel, akár háziállattal együtt.",
    images: ["https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=700&q=75", "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=700&q=75", "https://images.unsplash.com/photo-1471341971476-ae15ff5dd4ea?w=700&q=75"],
    price: "40 000 Ft-tól", duration: "1–2 óra",
  },
  {
    id: "egyeni", title: "Egyéni portré", subtitle: "A te pillanatod",
    desc: "Önbizalom-erősítő portré fotózás, brand fotók, színész portfólió vagy egyszerűen csak egy jó kép magadról.",
    images: ["https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=700&q=75", "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=700&q=75", "https://images.unsplash.com/photo-1554048612-b6a482bc67e5?w=700&q=75"],
    price: "25 000 Ft-tól", duration: "45–90 perc",
  },
];
      ...
      {!playing ? (
        <>
          ...
          <div className="absolute bottom-4 left-4">
            <span className="text-[9px] tracking-[0.15em] uppercase text-white/60 bg-[#1A1510]/50 backdrop-blur-sm px-2 py-1">Munkamódszer videó</span>
          </div>
        </>
      ) : (
