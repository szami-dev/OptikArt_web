...
const photographers = [
  {
    ...
    accent: "#C8A882",
    stats: [{ n: "200+", l: "Portré" }, { n: "7 év", l: "Tapasztalat" }],
  },
  {
    name: "Zugi Viktória",
    role: "Családi & Gyermek fotós",
    ...
    youtubeId: "dQw4w9WgXcQ",
    accent: "#B89870",
    stats: [{ n: "150+", l: "Család" }, { n: "5 év", l: "Tapasztalat" }],
  },
];
...
const categories = [
  {
    ...
    desc: "Helyszíni vagy stúdió fotózás, amely megörökíti a köztetek lévő kémia minden apró jelét. Jegyes-, évforduló- és szerelmespár fotózás.",
    images: [
      "https://images.unsplash.com/photo-1519741497674-611481863552?w=700&q=75",
      "https://images.unsplash.com/photo-1511285560929-80b456fea0bc?w=700&q=75",
      "https://images.unsplash.com/photo-1465495976277-4387d4b0b4c6?w=700&q=75",
    ],
    price: "35 000 Ft-tól",
    duration: "1–2 óra",
  },
  {
    ...
    desc: "Természetes, életteli képek a családról — gyerekekkel, nagyszülőkkel, akár háziállattal együtt. Helyszíni vagy stúdió.",
    images: [
      "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=700&q=75",
      "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=700&q=75",
      "https://images.unsplash.com/photo-1471341971476-ae15ff5dd4ea?w=700&q=75",
    ],
    price: "40 000 Ft-tól",
    duration: "1–2 óra",
  },
  {
    ...
    desc: "Önbizalom-erősítő portré fotózás, brand fotók, színész portfólió vagy egyszerűen csak egy jó kép magadról. Minden stílusban.",
    images: [
      "https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=700&q=75",
      "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=700&q=75",
      "https://images.unsplash.com/photo-1554048612-b6a482bc67e5?w=700&q=75",
    ],
    price: "25 000 Ft-tól",
    duration: "45–90 perc",
  },
...
// Mozaik képek – 5 cella különböző méretben
// Cseréld ki a sajátjaidra: src="/portrait/1.jpg"
const mosaicImages = [
  {
    src: "https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=800&q=80",
    alt: "Egyéni portré",
    // Nagy cella: 2 sor magas
  ...
  },
  {
    ...
    alt: "Páros fotó",
    // Kis cella: 1×1
    gridClass: "col-start-2 col-end-3 row-start-1 row-end-2",
  },
  {
  ...
  },
  {
    ...
    alt: "Esküvői portré",
    // Széles cella: 2 oszlop
    gridClass: "col-start-2 col-end-4 row-start-2 row-end-3",
  },
];
...
function YouTubeEmbed({ videoId, title }: { videoId: string; title: string }) {
  ...
  return (
    <div
      className="relative aspect-video bg-[#0D0B08] overflow-hidden group cursor-pointer"
      ...
      {!playing ? (
        <>
          ...
          <div className="absolute bottom-4 left-4">
            <span className="text-[9px] tracking-[0.15em] uppercase text-white/60 bg-[#1A1510]/50 backdrop-blur-sm px-2 py-1">
              Munkamódszer videó
            </span>
          </div>
        </>
...
export default function PortrePage() {
  ...
  useEffect(() => {
    ...
    async function init() {
      ...
      ctx = gsap.context(() => {
        ...
        tl
          .fromTo(".ph-mosaic-cell",
            { opacity: 0, scale: 1.05 },
            { opacity: 1, scale: 1, stagger: 0.08, duration: 1.1, ease: "power2.out" }
          )
          .fromTo(".ph-eyebrow",
            { opacity: 0, x: -16 },
        ...
        gsap.from(".ph-cat-header > *", {
          opacity: 0, y: 24, stagger: 0.1, duration: 0.8, immediateRender: false,
          scrollTrigger: { trigger: ".ph-cat-section", start: "top 80%", toggleActions: "play none none reverse" },
        });

        // Fotósok
        gsap.from(".ph-photo-card", {
          opacity: 0, y: 50, stagger: 0.15, duration: 1, ease: "power3.out", immediateRender: false,
          scrollTrigger: { trigger: ".ph-photographers", start: "top 75%", toggleActions: "play none none reverse" },
        });
  ...
  return (
    <div ref={rootRef} className="bg-white overflow-x-hidden">
      ...
      {/* ══════════════════════════════════════════
          HERO – Mozaik grid + szöveg overlay
          A szöveg a bal oldalon, jobb oldalt mozaik
      ══════════════════════════════════════════ */}
      <section
        className="relative w-full bg-white overflow-hidden"
        style={{ height: "100svh", minHeight: "600px" }}
      >
        {/* Teljes szélességű grid – abszolút pozíció, lefedi az egész szekciót */}
        <div className="absolute inset-0 grid grid-cols-2 lg:grid-cols-[1fr_38%_24%] grid-rows-2 gap-1.5 p-1.5">

          {/* Bal: fehér szöveg oszlop */}
          <div className="row-span-2 bg-white flex flex-col justify-between px-8 sm:px-10 lg:px-14 py-10 lg:py-14 relative z-10">

            {/* Fejléc */}
            <div className="flex items-center gap-3">
              <div className="w-8 h-px bg-[#C8A882]" />
              <span className="ph-eyebrow opacity-0 text-[9px] tracking-[0.28em] uppercase text-[#A08060]">
                OptikArt · Portré
              </span>
            </div>
            ...
            <div className="flex flex-col gap-6">
              <div className="text-[9px] tracking-[0.25em] uppercase text-[#C8A882] ph-title-word opacity-0">
                Pillantások
              </div>
              ...
              >
                ...
                <div className="ph-title-word opacity-0 overflow-hidden">
                  <em className="block not-italic text-[#C8A882]">emlékek.</em>
                </div>
              </div>
              ...
              <div className="flex flex-wrap items-center gap-4">
                <Link
                  href="/contact"
                  className="ph-hero-btn opacity-0 bg-[#1A1510] text-white text-[11px] tracking-[0.18em] uppercase px-7 py-3.5 hover:bg-[#C8A882] transition-all duration-300 whitespace-nowrap"
                >
                  Időpontot kérek
                </Link>
                <a
                  href="#kategoriák"
                  className="ph-hero-btn opacity-0 text-[11px] tracking-[0.14em] uppercase text-[#7A6A58] border-b border-[#C8A882]/40 pb-0.5 hover:text-[#1A1510] transition-all whitespace-nowrap"
                >
                  Kategóriák →
                </a>
              </div>
            ...
            {/* Alsó stat sor */}
            <div className="flex gap-6 pt-4 border-t border-[#EDE8E0]">
          ...
          <div className="ph-mosaic-cell opacity-0 relative overflow-hidden hidden lg:block">
            ...
            <div className="absolute bottom-3 left-3 z-10">
              <span className="text-[8px] tracking-[0.12em] uppercase text-white/70 bg-black/30 backdrop-blur-sm px-2 py-1">Páros</span>
            </div>
          </div>

          {/* Mozaik cella 3 – jobb alsó */}
          <div className="ph-mosaic-cell opacity-0 relative overflow-hidden hidden lg:block">
            <Image
            ...
            />
            <div className="absolute bottom-3 left-3 z-10">
              <span className="text-[8px] tracking-[0.12em] uppercase text-white/70 bg-black/30 backdrop-blur-sm px-2 py-1">Família</span>
            </div>
          </div>

          {/* Mobil: egyetlen háttérkép a jobb oldalon */}
          ...
          <div className="flex flex-wrap gap-2 mb-10">
            {categories.map((cat, i) => (
              <button
                ...
                className={`text-[11px] tracking-[0.12em] uppercase px-5 py-2.5 border transition-all duration-200 ${
                  activeCategory === i
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="flex flex-col gap-6">
              <div>
                ...
                <h3 className="font-['Cormorant_Garamond'] text-[clamp(1.8rem,3vw,2.8rem)] font-light text-[#1A1510] leading-[1.1] mb-4">
              ...
              <div className="flex gap-8 py-5 border-t border-b border-[#EDE8E0]">
                <div>
                  <div className="text-[9px] tracking-[0.15em] uppercase text-[#A08060] mb-1">Ár</div>
                  <div className="font-['Cormorant_Garamond'] text-[1.6rem] font-light text-[#1A1510]">{categories[activeCategory].price}</div>
                </div>
                <div>
                  <div className="text-[9px] tracking-[0.15em] uppercase text-[#A08060] mb-1">Időtartam</div>
                  <div className="font-['Cormorant_Garamond'] text-[1.6rem] font-light text-[#1A1510]">{categories[activeCategory].duration}</div>
                </div>
              </div>
      ...
      <section className="ph-photographers py-28 bg-white">
        <div className="max-w-7xl mx-auto px-8 lg:px-16">
          ...
          <h2 className="ph-split font-['Cormorant_Garamond'] text-[clamp(2.2rem,4vw,3.5rem)] font-light leading-[1.1] text-[#1A1510] mb-16">
          ...
          <div className="flex flex-col gap-24">
            {photographers.map((p, i) => (
              <div
                key={i}
                className={`ph-photo-card grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start ${i % 2 !== 0 ? "lg:[direction:rtl]" : ""}`}
              >
                <div className={`lg:col-span-5 ${i % 2 !== 0 ? "lg:[direction:ltr]" : ""}`}>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {p.specialties.map((s) => (
                      <span key={s} className="text-[9px] tracking-[0.1em] uppercase px-3 py-1.5 border border-[#EDE8E0] text-[#A08060]">{s}</span>
                    ))}
                  </div>
                </div>
                ...
                <div className={`lg:col-span-7 flex flex-col gap-7 ${i % 2 !== 0 ? "lg:[direction:ltr]" : ""}`}>
                  <div>
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <span className="text-[10px] tracking-[0.2em] uppercase" style={{ color: p.accent }}>Fotós</span>
                    </div>
                  ...
                  <div className="flex gap-8 py-5 border-t border-b border-[#EDE8E0]">
                    {p.stats.map((s) => (
                      <div key={s.l}>
                        <div className="font-['Cormorant_Garamond'] text-[2rem] font-light leading-none mb-0.5" style={{ color: p.accent }}>{s.n}</div>
                        <div className="text-[9px] tracking-[0.12em] uppercase text-[#A08060]">{s.l}</div>
                      </div>
                    ))}
                  </div>
                  <div>
                    <div className="flex items-center gap-3 mb-4">
                      <div className="w-5 h-px bg-[#EDE8E0]" />
                      <span className="text-[9px] tracking-[0.2em] uppercase text-[#A08060]">Így dolgozom</span>
                    </div>
      ...
      <section className="ph-cta-section relative py-32 overflow-hidden bg-[#1A1510]">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-8 text-center">
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <span className="text-[9px] tracking-[0.25em] uppercase text-[#C8A882]/60">Foglalj időpontot</span>
            <div className="w-8 h-px bg-[#C8A882]/50" />
          </div>
          ...
          <p className="text-[14px] text-white/40 leading-[1.9] mb-10 max-w-md mx-auto">
            Egyeztesd az időpontot most, és mi gondoskodunk a többiről.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/contact" className="bg-white text-[#1A1510] text-[11px] tracking-[0.18em] uppercase px-10 py-4 hover:bg-[#C8A882] hover:text-white transition-colors duration-300 whitespace-nowrap">
              Időpontot kérek
            </Link>
            <a href="tel:+36301234567" className="border border-white/20 text-white/60 text-[11px] tracking-[0.15em] uppercase px-8 py-4 hover:border-[#C8A882]/50 hover:text-white/80 transition-all duration-300 whitespace-nowrap">
              +36 30 123 4567
            </a>
          </div>
        </div>
